console.log("Hello from the console side");
var player1 = prompt("Player One: Enter Your Name , you will be Blue");
var player1Color = 'rgb(86, 151, 255)';//blue color

var player2 = prompt("Player Two: Enter Your Name, you will be Red");
var player2Color = 'rgb(237, 45, 73)';//red color

var game_on = true;//to check if the game is still going on or not
var table = $('table tr');//jquery to call the table
...
function checkBottom(colIndex) {
  ...
  for (var row = 5; row > -1; row--) {
    ...
    if (colorReport === 'rgb(128, 128, 128)') {
      return row;//returns row if the color is gray
    }
  }
}

// Check to see if 4 inputs are the same color and not of gray color or undefined
function colorMatchCheck(one,two,three,four){
  return (one===two && one===three && one===four && one !== 'rgb(128, 128, 128)' && one !== undefined);
}

// Check for Horizontal Wins, for example
// 1
// 2
// 3
// 4
...
// Check for Vertical Wins, for example
// 1 2 3 4
...
// Check for Diagonal Wins, for example
// 1
//     2
//         3
//             4
